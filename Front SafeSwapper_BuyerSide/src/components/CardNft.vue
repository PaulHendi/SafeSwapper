    ...
    <q-card class="app-card">
      ...
      <q-card-section class="q-pa-lg" v-if="BuyerText">
        <div class="row justify-between">
          <div class="column">
            <h3 class="q-my-none text-bold">{{BuyerText}}</h3>
          </div>
        </div>
        <div class="row items-end">
          ...
          <q-input
            ...
            <q-input
              v-model="NecessaryEGLD"
              class="q-mx-auto q-gutter-md-md col-12 col-md-6 q-mb-md q-mb-md-none"
              placeholder="Necessary EGLD"
              type="number"
              outlined
              square
              dense
        ...
        <div class="column">
        <h3 class="q-my-none text-bold">You'll find here the transaction ID</h3>

        <h10 class="q-my-none">{{TxID}}</h10>
